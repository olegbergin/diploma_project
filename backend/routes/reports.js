 ...
 * GET /api/businesses/:id/reports/generate?period=month&date=2025-01
 * GET /api/businesses/:id/reports/generate?period=year&date=2025
 */
router.get("/businesses/:id/reports/generate", async (req, res) => {
  try {
 ...
 */
router.get("/businesses/:id/reports/preview", async (req, res) => {
  try {
    const { id: businessId } = req.params;
    const { period, date } = req.query;
 ...
 */
router.get("/businesses/:id/reports/available-dates", async (req, res) => {
  try {
    const { id: businessId } = req.params;
